/* Copyright (C) 2020 Deepin Latin Code - developers.
*                    Comunidad de Deepin En Español
*
* Authors:     Alvaro Samudio(G4SP3R)<alvarosamudio@criptext.com>
*
*
...
//    a.setTheme("light");
    ...
    a.setApplicationName("DTK test");
    a.setApplicationVersion("1.0");
    a.setProductIcon(QIcon(":/images/dtk-test.svg"));
    a.setProductName("DTK-test");
...
//De este modo se podra traducir a otros idiomas
    a.loadTranslator();
    a.setApplicationDisplayName(QObject::tr("DTK test"));
